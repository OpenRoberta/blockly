...
Blockly.Msg.BLE_ADAPTER_DISABLED = "Wir konnten auf keinen Bluetooth Adapter zugreifen.<br>Schau mal in unser <a href='https://wiki.open-roberta.org/' target='_blank'>Wiki</a> für weitere Informationen unter: Spike Pybricks↪Bluetooth aktivieren.";
...
Blockly.Msg.BLE_ERROR_CAPABILITIES = "Deine Hub-Version kann nicht mit dem Lab verbunden werden. Schau in unser <a href='https://wiki.open-roberta.org/' target='_blank'>Wiki</a> für weitere Informationen.";
...
Blockly.Msg.BLE_ERROR_DEVICE_BUSY = "Sieht so aus als wäre dein Roboter bereits mit einem Lab verbunden. Schließe das andere Lab oder starte deinen Roboter neu.";
Blockly.Msg.BLE_ERROR_PROGRAM_SIZE = "Dein Programm ist zu groß für den Spike Prime. Schau in unser <a href='https://wiki.open-roberta.org/' target='_blank'>Wiki</a> für weitere Informationen.";
Blockly.Msg.BLE_ERROR_STOP = "Wir konnten das Programm leider nicht für dich stoppen. Du kannst den großen runden Knopf der Hub benutzen, um das Programm selber zu stoppen.";
Blockly.Msg.BLE_FEATURE_DISABLED = "Scheint, als wäre Webble nicht aktiviert.<br>Schau mal in das <a href='https://wiki.open-roberta.org/' target='_blank'>Wiki</a> für weitere Informationen unter: Spike Pybricks↪Webble aktivieren.";
Blockly.Msg.BLE_NOT_SUPPORTED = "Nicht alle Browser unterstützen Webble.<br>Schau mal in unser <a href='https://wiki.open-roberta.org/' target='_blank'>Wiki</a> für weitere Informationen unter: Spike Pybricks↪Unterstützte Browsers.";
Blockly.Msg.BLE_NO_DEVICE_SELECTED = "Scheint, als hättest du kein Gerät ausgewählt.<br>Wenn dein Hub nicht angezeigt wurde, im <a href='https://wiki.open-roberta.org/' target='_blank'>Wiki</a> findest du eine Anleitung wie du dein Hub einrichten kannst.";
