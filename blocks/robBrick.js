...
Blockly.Blocks["robBrick_EV3-Brick"] = {
  ...
  init: function () {
    ...
    var wheelDiameter = new Blockly.FieldTextInput(
      "0",
      Blockly.FieldTextInput.nonnegativeNumberValidator
    );
    var trackWidth = new Blockly.FieldTextInput(
      "0",
      Blockly.FieldTextInput.nonnegativeNumberValidator
    );
    this.appendDummyInput().appendField(
      new Blockly.FieldLabel(this.workspace.device.toUpperCase(), "brick_label")
    );
    this.appendDummyInput()
      .appendField(Blockly.Msg.BRICK_WHEEL_DIAMETER)
      .appendField(wheelDiameter, "WHEEL_DIAMETER")
      .appendField("cm");
    this.appendDummyInput()
      .appendField(Blockly.Msg.BRICK_TRACK_WIDTH)
      .appendField(trackWidth, "TRACK_WIDTH")
      .appendField("cm");
    ...
    this.appendValueInput("S4")
      ...
      .setAlign(Blockly.ALIGN_RIGHT)
      .setCheck("Sensor");
    this.appendValueInput("MA")
      .appendField("Motor A")
      .setAlign(Blockly.ALIGN_RIGHT)
      .setCheck("Actor");
    this.appendValueInput("MB")
      .appendField("Motor B")
      .setAlign(Blockly.ALIGN_RIGHT)
      .setCheck("Actor");
    this.appendValueInput("MC")
      .appendField("Motor C")
      .setAlign(Blockly.ALIGN_RIGHT)
      .setCheck("Actor");
    if (this.workspace.device === "ev3") {
      this.appendValueInput("MD")
        .appendField("Motor D")
        .setAlign(Blockly.ALIGN_RIGHT)
        .setCheck("Actor");
...
Blockly.Blocks["robBrick_WeDo-Brick"] = {
  init: function () {
    var name = Blockly.Variables.findLegalName(
      Blockly.Msg.BRICKNAME_WEDO.charAt(0).toUpperCase(),
      this
    );
    this.nameOld = name;
...
Blockly.Blocks["robBrick_senseBox-Brick"] = {
  ...
  init: function () {
    ...
    this.setInputsInline(false);
    this.appendDummyInput().appendField(
      new Blockly.FieldLabel("senseBox", "brick_label")
    );
    this.appendDummyInput()
      .appendField(Blockly.Msg.BOX_ID)
      .appendField(new Blockly.FieldTextInput("", this.idValidator), "BOX_ID")
      .setAlign(Blockly.ALIGN_RIGHT);
    this.appendDummyInput("ADD1")
      .appendField(Blockly.Msg.BRICK_PHENOMENON)
      .appendField(
        new Blockly.FieldTextInput(
          this.findLegalName_("ID1"),
          this.nameValidator
        ),
        "NAME1"
      )
      .appendField(Blockly.Msg.ID)
      .appendField(new Blockly.FieldTextInput("", this.idValidator), "ID1")
      .setAlign(Blockly.ALIGN_RIGHT);
    this.idCount_ = 1;
  ...
  domToMutation: function (xmlElement) {
    ...
    for (var x = 2; x <= this.idCount_; x++) {
      this.appendDummyInput("ADD" + x)
        .appendField(Blockly.Msg.BRICK_PHENOMENON)
        .appendField(
          new Blockly.FieldTextInput("", this.nameValidator),
          "NAME" + x
        )
        .appendField(Blockly.Msg.ID)
        .appendField(new Blockly.FieldTextInput("", this.idValidator), "ID" + x)
        .setAlign(Blockly.ALIGN_RIGHT);
    }
    if (this.idCount_ >= 2) {
  ...
  updateShape_: function (num) {
    if (num == 1) {
      ...
      this.appendDummyInput("ADD" + this.idCount_)
        ...
        .appendField(
          new Blockly.FieldTextInput(
            this.findLegalName_("ID" + this.idCount_),
            this.nameValidator
          ),
          "NAME" + this.idCount_
        )
        .appendField(Blockly.Msg.ID)
        .appendField(
          new Blockly.FieldTextInput("", this.idValidator),
          "ID" + this.idCount_
        )
        .setAlign(Blockly.ALIGN_RIGHT);
    } else if (num == -1) {
  ...
  updateSendData_: function (num) {
    ...
    if (container) {
      var blocks =
        Blockly.Workspace.getByContainer("blocklyDiv").getAllBlocks();
  ...
  findLegalName_: function (name) {
    ...
    var isLegalName = function (name) {
      for (var x = 0; x <= that.idCount_; x++) {
        if (
          that.getField("NAME" + x) &&
          that.getField("NAME" + x).getValue() === name
        ) {
          return false;
        }
      }
...
Blockly.Blocks["robBrick_ardu-Brick"] = {
  ...
  init: function () {
    ...
    this.setInputsInline(false);
    this.appendDummyInput().appendField(
      new Blockly.FieldLabel("Bot'n Roll", "brick_label")
    );
    this.appendValueInput("S1")
    ...
    this.appendValueInput("S6")
      .appendField(Blockly.Msg.CENTER)
      .setAlign(Blockly.ALIGN_RIGHT)
      .setCheck("Sensor");
    ...
    this.appendValueInput("S9")
      ...
      .setCheck("Sensor");
    this.appendDummyInput()
      .appendField("Extra 'B' Search Rescue")
      .setAlign(Blockly.ALIGN_CENTER);
    this.appendValueInput("S10")
      .appendField(Blockly.Msg.SENSOR_SONAR)
      .setAlign(Blockly.ALIGN_RIGHT)
      .setCheck("Sensor");
    this.appendValueInput("MC")
      .appendField(Blockly.Msg.MOTOR_PAN)
      .setAlign(Blockly.ALIGN_RIGHT)
      .setCheck("Actor");
    this.appendValueInput("MD")
      .appendField(Blockly.Msg.MOTOR_TILT)
      .setAlign(Blockly.ALIGN_RIGHT)
      .setCheck("Actor");
...
Blockly.Blocks["robBrick_vorwerk-Brick"] = {
  ...
  init: function () {
    ...
    var port = new Blockly.FieldTextInput(
      "22",
      Blockly.FieldTextInput.nonnegativeNumberValidator
    );
    ...
    this.appendDummyInput().appendField(
      new Blockly.FieldLabel("Vorwerk", "brick_label")
    );
    this.appendDummyInput()
      .appendField(Blockly.Msg.BRICK_IPADDRESS)
      .appendField(ipAddress, "IP_ADDRESS");
    this.appendDummyInput()
      .appendField(Blockly.Msg.BRICK_PORT)
      .appendField(port, "PORT");
    this.appendDummyInput()
      .appendField(Blockly.Msg.BRICK_USERNAME)
      .appendField(username, "USERNAME");
    this.appendDummyInput()
      .appendField(Blockly.Msg.BRICK_PASSWORD)
...
Blockly.Blocks["robBrick_HiTechnic_colour"] = {
  ...
  init: function () {
    this.setColour(Blockly.CAT_SENSOR_RGB);
    this.appendDummyInput().appendField(
      "HiTechnic" + Blockly.Msg.SENSOR_COLOUR
    );
    this.setOutput(true, "Sensor");
...
Blockly.Blocks["robBrick_motor_big"] = {
  ...
  init: function () {
    ...
    this.appendDummyInput()
      .appendField(Blockly.Msg.MOTOR_REGULATION)
      .appendField(motorRegulation, "MOTOR_REGULATION")
      .setAlign(Blockly.ALIGN_RIGHT);
    this.appendDummyInput()
      .appendField(Blockly.Msg.MOTOR_ROTATION_REVERSE)
      .appendField(motorReverse, "MOTOR_REVERSE")
      .setAlign(Blockly.ALIGN_RIGHT);
    this.appendDummyInput()
      .appendField(Blockly.Msg.MOTOR_SIDE)
      .appendField(motorSide, "MOTOR_DRIVE")
      .setAlign(Blockly.ALIGN_RIGHT);
    this.setOutput(true, "Actor");
